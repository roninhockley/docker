            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-6">
                            <a class="img-responsive" href="#" data-toggle="modal" data-target="photo-library">
                                <img src="<?php echo $user->image_path_and_placeholder(); ?>" >
                            </a>
                        </div>


                        <form action="" method="post" enctype='multipart/form-data'> <!-- default action is self, i.e. "edit_user.php -->
